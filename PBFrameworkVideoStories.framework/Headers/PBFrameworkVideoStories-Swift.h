...
#ifndef PBFRAMEWORKVIDEOSTORIES_SWIFT_H
#define PBFRAMEWORKVIDEOSTORIES_SWIFT_H
...
SWIFT_CLASS("_TtC23PBFrameworkVideoStories12ARExperience")
@interface ARExperience : UIViewController
+ (ARExperience * _Nonnull)create SWIFT_WARN_UNUSED_RESULT;
- (void)viewDidLoad;
...
@property (nonatomic) BOOL isUsingAppGroup;
...
SWIFT_CLASS("_TtC23PBFrameworkVideoStories22MessagesViewController")
...
@interface MessagesViewController (SWIFT_EXTENSION(PBFrameworkVideoStories)) <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC23PBFrameworkVideoStories6PBCine")
@interface PBCine : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, copy) NSString * _Nullable streamTemplateListURL;
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull streamTemplateListFilter;
...
@interface PBVideoStoriesViewController (SWIFT_EXTENSION(PBFrameworkVideoStories)) <UITextFieldDelegate>
- (BOOL)textFieldShouldReturn:(UITextField * _Nonnull)textField SWIFT_WARN_UNUSED_RESULT;
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
...
@interface PBVideoStoriesViewController (SWIFT_EXTENSION(PBFrameworkVideoStories)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
- (void)downloadVideoStoryAndUpdateImagesWithVideoStoryThemeURL:(NSURL * _Nonnull)videoStoryThemeURL uuid:(NSString * _Nonnull)uuid themeId:(NSString * _Nullable)themeId successBlock:(void (^ _Nullable)(NSURL * _Nullable, NSURL * _Nullable, NSURL * _Nullable, NSURL * _Nullable, NSURL * _Nullable, NSDictionary<NSString *, id> * _Nullable, NSURL * _Nullable, NSDictionary<NSString *, id> * _Nullable))successBlock failureBlock:(void (^ _Nullable)(NSError * _Nullable))failureBlock progressBlock:(void (^ _Nullable)(float, float))progressBlock;
@end
...
+ (PBVideoStoryView * _Nullable)createWith:(CGRect)frame category:(NSDictionary<NSString *, id> * _Nonnull)category SWIFT_WARN_UNUSED_RESULT;
+ (PBVideoStoryView * _Nullable)createWith:(CGRect)frame categoryTheme:(NSDictionary<NSString *, id> * _Nonnull)categoryTheme SWIFT_WARN_UNUSED_RESULT;
...
+ (PBVideoStoryView * _Nullable)createUnloadedViewWith:(CGRect)frame coverURL:(NSString * _Nonnull)coverURL SWIFT_WARN_UNUSED_RESULT;
+ (PBVideoStoryView * _Nullable)createComingSoonViewWith:(CGRect)frame image:(UIImage * _Nonnull)image SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC23PBFrameworkVideoStories19TemplatesDataSource")
@interface TemplatesDataSource : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface TemplatesDataSource (SWIFT_EXTENSION(PBFrameworkVideoStories)) <UIScrollViewDelegate>
- (void)scrollViewDidScroll:(UIScrollView * _Nonnull)scrollView;
@end


@interface TemplatesDataSource (SWIFT_EXTENSION(PBFrameworkVideoStories)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)collectionView:(UICollectionView * _Nonnull)collectionView didSelectItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
@interface TemplatesDataSource (SWIFT_EXTENSION(PBFrameworkVideoStories)) <UITableViewDataSource, UITableViewDelegate>
...
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (UISwipeActionsConfiguration * _Nullable)tableView:(UITableView * _Nonnull)tableView trailingSwipeActionsConfigurationForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=11.0) SWIFT_AVAILABILITY(ios_app_extension,introduced=11.0);
@end


SWIFT_CLASS("_TtC23PBFrameworkVideoStories23TemplatesViewController")
@interface TemplatesViewController : UIViewController
@property (nonatomic, copy) NSString * _Nullable streamID;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
+ (TemplatesViewController * _Nonnull)create SWIFT_WARN_UNUSED_RESULT;
- (BOOL)textFieldShouldReturn:(UITextField * _Nonnull)textField SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface TemplatesViewController (SWIFT_EXTENSION(PBFrameworkVideoStories)) <UITextFieldDelegate>
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
- (BOOL)textFieldShouldClear:(UITextField * _Nonnull)textField SWIFT_WARN_UNUSED_RESULT;
- (void)textFieldDidBeginEditing:(UITextField * _Nonnull)textField;
@end
...
@property (nonatomic, copy) NSString * _Nullable backgroundVideo;
...
@property (nonatomic, copy) NSArray<NSDictionary<NSString *, id> *> * _Nullable layeredVideo;
